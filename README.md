...
Personal fork of [PrimeIntellect-ai/prime-agent](https://github.com/PrimeIntellect-ai/prime-agent)
(baseline commit `10fb172b`, between v0.7.1 and v0.7.2). Harness source is
unmodified upstream; my work lives in:

- **`skills/`** — research skill suite (see [FORK_NOTES.md](FORK_NOTES.md))
- **`deploy.sh`** — Windows → WSL dual-venv skill deployment
